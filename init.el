...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (yaml-mode lua-mode lsp-java doom-themes company-lsp lsp-mode monokai-theme yasnippet use-package smex magit eterm-256color eglot counsel-projectile company ace-window)))
